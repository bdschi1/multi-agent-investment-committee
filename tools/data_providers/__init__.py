...
Allows seamless switching between Yahoo Finance (default), Bloomberg, and
Interactive Brokers as the market data source.  All providers return
identical dict schemas so the rest of the tool layer is data-source agnostic.
